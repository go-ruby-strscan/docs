...
`go-ruby-strscan/strscan` reimplements Ruby's StringScanner in **pure Go, with cgo disabled**. The
...
- any Go program can import `github.com/go-ruby-strscan/strscan` directly, with no Ruby runtime;
